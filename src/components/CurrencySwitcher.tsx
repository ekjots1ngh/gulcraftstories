  ...
  return (
    <label className={cn("inline-flex items-center", className)}>
      ...
      <select
        ...
        className={cn(
          "min-h-11 cursor-pointer rounded-sm border bg-transparent px-1.5 text-xs font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-gold sm:min-h-9 sm:px-2",
