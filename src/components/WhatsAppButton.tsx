...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-3 right-3 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-peacock text-cream shadow-[var(--shadow-soft)] transition-colors hover:bg-peacock-deep sm:bottom-6 sm:right-6 sm:h-auto sm:w-auto sm:gap-2 sm:py-3 sm:pl-3 sm:pr-3"
    >
